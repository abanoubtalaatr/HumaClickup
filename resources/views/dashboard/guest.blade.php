...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="py-6">
        ...
        @php
            // 20-day program: progress = tasks/20, hours = tasks×6 (e.g. 3 tasks = 15%, 18/120h)
            $user = auth()->user();
            ...
            $hoursPerTask = 6;
            $targetHours = $totalProgramTasks * $hoursPerTask;
            ...
            $totalCompletedHours = $completedMainTasks * $hoursPerTask;
