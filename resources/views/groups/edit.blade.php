...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="py-6">
        ...
        <div class="mb-6">
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Update group details and members</p>
        </div>
            ...
            <form action="{{ route('groups.update', $group) }}" method="POST" class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" 
                              ...
                              rows="3"
                              class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                              placeholder="Brief description of this group...">{{ old('description', $group->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="url" 
                               name="whatsapp_link" 
                               id="whatsapp_link" 
                               value="{{ old('whatsapp_link', $group->whatsapp_link) }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               name="slack_link" 
                               id="slack_link" 
                               value="{{ old('slack_link', $group->slack_link) }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               name="repo_link" 
                               id="repo_link" 
                               value="{{ old('repo_link', $group->repo_link) }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               name="service_link" 
                               id="service_link" 
                               value="{{ old('service_link', $group->service_link) }}"
                            ...
                            @foreach($availableGuests as $guest)
                                <label class="flex items-center p-2 hover:bg-gray-50 dark:hover:bg-gray-700 rounded cursor-pointer">
                                    <input type="checkbox" 
                                           name="guest_ids[]" 
                                           value="{{ $guest->id }}"
                                           {{ in_array($guest->id, old('guest_ids', $assignedGuestIds)) ? 'checked' : '' }}
