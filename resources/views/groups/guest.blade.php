...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="py-6">
        ...
        <div class="mb-6">
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Groups you are assigned to</p>
        </div>
        ...
        @if($groups->isEmpty())
            <div class="text-center py-12 bg-white dark:bg-gray-800 rounded-lg shadow">
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">You haven't been assigned to any groups.</p>
            </div>
        @else
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
                        <div class="p-6">
                            ...
                            <div class="border-t border-gray-200 dark:border-gray-700 pt-4">
                                <h4 class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase mb-2">Group Members ({{ $group->guests->count() }})</h4>
                                <div class="space-y-2">
                                    @foreach($group->guests->take(5) as $guest)
                                    ...
                                    @endforeach
                                    @if($group->guests->count() > 5)
                                        <p class="text-xs text-gray-500 dark:text-gray-400">
                                            +{{ $group->guests->count() - 5 }} more
                                        </p>
                                    @endif
                                </div>
                            </div>
